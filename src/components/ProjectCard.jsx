...
const ProjectCard = ({ title, description, imageUrl, liveLink, repoLink }) => {
  return (
    <div className="max-w-sm border border-none rounded-none overflow-hidden shadow-lg m-4">
      ...
      <div className="bg-gray-800 min-h-[150px] md:min-h-[200px]"> {/* Darker background for the card */}
        <h2 className="text-lg md:text-xl font-bold py-2 text-white text-center">{title}</h2>
